...
/**
 * Created by upendra on 11/9/2020.
 */

public class ReferenceVariablesForDownloadActivity {
    protected TableStructureGetterSetter tableStructureObj;
    protected MappingPromotionGetterSetter masternonpromoReason,mappingPromotionGetterSetter,masterpromoType;
    protected JCPGetterSetter jcpObject,masterprogram;

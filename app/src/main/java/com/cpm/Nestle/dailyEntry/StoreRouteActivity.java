...
public class StoreRouteActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        store = (MappingJourneyPlan) getIntent().getSerializableExtra(CommonString.TAG_OBJECT);
    ...
    public void showMarker(MappingJourneyPlan lat, double lon) {
        ...
        desc.setText(store.getStoreName());
        ...
        LatLng loc = new LatLng(Double.parseDouble(String.valueOf(store.getLongitude())), Double.parseDouble(String.valueOf(store.getLongitude())));
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED
            ...
            if (mLastLocation != null) {
                ...
                mMap.setMyLocationEnabled(true);
                    ...
                    destination = new LatLng(Double.parseDouble(String.valueOf(store.getLongitude())), Double.parseDouble(String.valueOf(store.getLongitude())));

                    MappingJourneyPlan store1 = new MappingJourneyPlan();
                    store1.setLatitude(Float.valueOf(latitude+""));
                    store1.setLongitude(Float.valueOf(longitude+""));
                    store1.setStateName("Current Location");
                    showMarker(store1, R.layout.current_marker_view);

                    showMarker(store, R.layout.marker_view);

                LatLngBounds.Builder builder = new LatLngBounds.Builder();
                builder.include(new LatLng(Double.parseDouble(String.valueOf(store.getLatitude())), Double.parseDouble(String.valueOf(store.getLongitude()))));
    ...
    public void showMarker(MappingJourneyPlan store, int layout_resource){
        ...
        tv.buildDrawingCache();
        Bitmap bm = tv.getDrawingCache();
        LatLng loc = new LatLng(Double.parseDouble(String.valueOf(store.getLatitude())), Double.parseDouble(String.valueOf(store.getLongitude())));
        mMap.addMarker(new MarkerOptions().position(loc).anchor(0.5f, 0.5f).icon(BitmapDescriptorFactory.fromBitmap(bm)));
